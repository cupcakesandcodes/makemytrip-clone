...
const Canceldetail = () => {
  ...
  // If there’s no data, show fallback UI instead of crashing
  if (!res || !res.airline || !res.departure || !res.arrival) {
    return (
      <div style={{ textAlign: "center", padding: "40px", color: "gray" }}>
        <h2>No flight selected ✈️</h2>
        <p>Please select a flight first to view cancellation details.</p>
      </div>
    )
  }
